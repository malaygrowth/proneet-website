export const SITE = {
  ...
  description: "Small-batch NEET & JEE coaching in Mansarovar, Jaipur. Physics by Neeraj Gupta (20+ yrs) & Chemistry by Vivek Patidar. 30-seat batches, 1000+ selections.",
